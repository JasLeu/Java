...
public class MemoryGame
{
  public static void main(String[] args) {
    String[] memoryStrings = {"red", "green", "blue"};
    ...
    boolean cont = true;
    while (cont) {
      String[] randSequence = memoryStrings;
      System.out.println(randSequence);
      if (board.playSequence(randSequence, .25).equals(randSequence)) {
